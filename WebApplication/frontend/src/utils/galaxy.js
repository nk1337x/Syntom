...
var StarField = /** @class */ (function () {
    ...
    StarField.prototype.setCanvasSize = function () {
        ...
        var width = this.canvas.width, height = this.canvas.height, size = Math.max(width, height), depth = size * this.containerDepth, screen = [width, height], container = [size, depth];
        // set latest sizes
        this.container = container;
        this.screen = screen;
        // center
...
export function initGalaxyBackground(canvas) {
    var IS_MOBILE = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
    var starCount = IS_MOBILE ? 500 : 1000;
